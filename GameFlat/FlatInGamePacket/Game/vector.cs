...
public struct vector : IFlatbufferObject
{
  ...
  public static Offset<FlatInGamePacket.Game.vector> Createvector(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
  ...
  public static Offset<FlatInGamePacket.Game.vector> Endvector(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatInGamePacket.Game.vector>(o);
  }
}


static public class vectorVerify
{
